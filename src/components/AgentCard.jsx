  ...
  return (
    <>
      <div>
        <Card
          shadow={false}
          className="relative grid h-[40rem] w-full max-w-[28rem] items-end justify-center overflow-hidden text-center  rounded-2xl"
        >
          <CardHeader
            floated={false}
            shadow={false}
            ...
            style={{
              backgroundImage: `url(${fullPortrait || fullPortraitV2})`,
            }}
          >
